...
//    std::cout << "\ndone.\n";
    ...
    // beginning of miscellaneous workspace
...
//    std::cout << out << "\n";
    ...
    int number_of_remainder_walls = cube.splitWalls(walls_in, tilesPerSide, walls_out, 4*tilesPerSide, lateral_walls, listener, 1, 1);
...
//    }
    ...
    int number_of_lateral_walls = cube.segmentWallsBasedOnAzimuth(lateral_walls, listener, segmented_lateral_walls, channels);
...
//
    std::cout << "\nTotal walls intended are: " << tilesPerSide * (6+2) << "\n";
    
    std::cout << "\nTotal walls now are: " << number_of_lateral_walls + number_of_remainder_walls << "\n";
    
//    cube.sliceRemainder(tilesPerSide * (6+2), tilesPerSide * (6+2) - (number_of_remainder_walls), walls_out);
//
//
//    //printing the rest of the walls, except lateral walls
